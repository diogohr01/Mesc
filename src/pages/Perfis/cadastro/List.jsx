    ...
    () => [
      {
        columns: 2,
        questions: [
          { type: 'text', id: 'cod_perfil', required: false, placeholder: 'Código...', label: 'Código', size: 'middle' },
        ...
        <Row gutter={[8, 8]}>
          <Col span={24}>
            <Card
              ...
              extra={
                <Space>
                  <Button type="primary" icon={<AiOutlinePlus />} onClick={onAdd} size="middle">Novo Perfil</Button>
                  <FilterModalForm
