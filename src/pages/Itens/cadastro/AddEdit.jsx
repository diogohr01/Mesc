    ...
    () => [
      {
        ...
        questions: [
          ...
          { type: 'decimal', id: 'percentual_perda', required: false, placeholder: '0', label: '% Perda', precision: 2, min: 0, max: 100 },
      ...
      try {
        ...
        if (result.success && result.data?.data) {
          ...
          const deserializedRecord = {
            ...
            percentual_perda: r.percentual_perda ?? r.percentualPerda ?? 0,
